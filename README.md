...
> Delivered in phases — see [Development phases](#development-phases). Currently: **Phase 5 — Tasks** complete.
...
5. **Tasks** — CRUD, assignment, Kanban board (drag & drop), priority + assignee filters ← _current_
